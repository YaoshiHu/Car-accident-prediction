...
generator = os.walk(file_dir)
folders = None
for dirs in generator:
    folders = dirs[1]
    break
...
if __name__ == '__main__':
    ...
    with open(loss_dir, "w+") as model_file:
        model_file.write("First Training start at {}\n".format(datetime.now()))
    print("Start loading training data")

    X, A, Y = load_from_dir('/home/yaoshihu/downloads/data/gcn_input_features.h5')
    ...
    # logging the data
    save_numpy_array(loss_dir, call_back)
    ...
    # with open("./models/model_structure.json", "w") as json_file:
